...
Route::get('/document/get_all', [App\Http\Controllers\DocumentController::class, 'GET_ALL']);
Route::post('/document/create', [App\Http\Controllers\DocumentController::class, 'UPSERT']);
Route::post('/document/delete', [App\Http\Controllers\DocumentController::class, 'DELETE_Document']);
